    ...
    async function fetchProjectData() {
        try {
            ...
            if (projectRes.ok) {
                ...
                router.push('/seo/link-indexing/projects')
                return
            }
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-1 text-sm text-muted-foreground">
                                <Link href="/seo/link-indexing" className="hover:text-foreground">
                                    Link Indexing
                                </Link>
                                <span>/</span>
                                <Link href="/seo/link-indexing/projects" className="hover:text-foreground">
                                    Projects
                                </Link>
                                <span>/</span>
