                    ...
                    {loading ? (
                        ...
                        <div className="p-8 text-center">
                            ...
                            <p className="text-sm text-muted-foreground mb-4">
                                Create your first project to start indexing URLs
                            </p>
                            <Button onClick={openNewDialog}>
                                <Plus className="mr-2 h-4 w-4" />
                                Create Project
                            ...
                            <TableBody>
                                {projects.map((project) => (
                                    <TableRow
                                        ...
                                        onClick={() => router.push(`/seo/link-indexing/projects/${project.id}`)}
                                    >
                                        <TableCell>
                    ...
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {editingProject
                                ...
                                : 'Create a new project to organize your URLs'}
                        </DialogDescription>
                    </DialogHeader>
